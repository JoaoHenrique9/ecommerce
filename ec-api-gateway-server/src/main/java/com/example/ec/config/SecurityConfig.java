    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(GET, PUBLIC_GET).permitAll()
                        .pathMatchers(POST, "/user-service/users").permitAll()
                        .pathMatchers(POST, "/order-service/orders")
                        .hasAnyRole("USER", "ADMIN")
                        .pathMatchers(GET, USER_GET).hasAnyRole("USER", "ADMIN")
                        .pathMatchers(PUT, USER_PUT).hasAnyRole("USER", "ADMIN")
                        .pathMatchers(DELETE, USER_DELETE).hasAnyRole("USER", "ADMIN")
