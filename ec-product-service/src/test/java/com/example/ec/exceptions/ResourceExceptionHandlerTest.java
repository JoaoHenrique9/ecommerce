...
class ResourceExceptionHandlerTest {
    ...
    @Test
    void shouldQuantityException() {

        String errorMessage = "O valor é maior que a quantidade atual";
        QuantityException exception = new QuantityException(errorMessage);

        ResponseEntity<StandardError> response = exceptionHandler.quantityException(exception, request);
        ...
        assertThat(response.getBody())
                ...
                .extracting(StandardError::getStatus, StandardError::getError,
                        StandardError::getMessage,
                        StandardError::getPath)
                .containsExactly(BAD_REQUEST.value(),
                        "Bad Request",
                        "O valor é maior que a quantidade atual",
                        request.getRequestURI());
